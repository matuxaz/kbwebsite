...
<div id="comment-{{ $comment->getKey() }}" class="media">
    <img class="mr-3" src="/avatars/{{$comment->commenter->profile_photo_path}}" style="width:30px; height:30px; border-radius:50%;" alt="{{ $comment->commenter->name ?? $comment->guest_name }} Avatar">
