    ...
    <div class="card">
        ...
        <div class="card-body">
            ...
            @if(isset($names))
                ...
                {!! Form::model($names, ['url' => ['admin/names', $names->id], 'method' => 'patch']) !!}
            @else
                {{-- Naujo įrašo įvedimo forma; metodo nereikia nurodyti, nes pagal nutylėjimą jis yra 'post' --}}
                {!! Form::open(['url' => 'admin/names', 'class' => 'needs-validation']) !!}
            @endif

            <div class="form-group">
                {!! Form::label('firstname', 'First Name: ', ['class' => 'col-sm-3']) !!}
                <div class="col-sm-6">
                    {!! Form::text('firstname', null, ['class' => 'form-control', 'required' => 'required']) !!}
                </div>
            </div>
            <div class="form-group">
                {!! Form::label('lastname', 'Last name: ', ['class' => 'col-sm-3']) !!}
                <div class="col-sm-6">
